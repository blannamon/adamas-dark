...
- **Read `DESIGN-GUIDE.md`** before writing any frontend code. It contains all colors, typography, layout tokens, and component patterns for this project.
- **Read the `MOBILE_VERSION.md`** file before creating/editing the mobile version.
